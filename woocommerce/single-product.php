					...
					<div class="cr-full-program-popup-body">
						<div class="cr-full-program-popup col-xs-12">
							...
							<div class="full-program-body ">
								<p>
									<strong>Комп'ютерні програми:</strong>  ArchiCad, Artlantic, AdobePhotoshop <br>
									<strong>Онлайн сервіси:</strong>  Polivore <br>
									<strong>Виконання робочих креслень:</strong>  ArchiCad <br>
									<strong>Візуалізація:</strong>  ArchiCad, AdobePhotoshop <br>
								</p>
								<p><strong>Практичні занняття:</strong></p>
								<ul>
									<li>Виїзд на обміри</li>
									<li>Обмірний план</li>
									<li>План монтажу та демонтажу</li>
									<li>Робочий план (план перепланування)</li>
									<li>План меблювання</li>
									<li>План підлоги та стелі</li>
									<li>Схема електрики</li>
									<li>Розгортки по стінах</li>
									<li>Розкладка плитки санвузлів</li>
									<li>Розробка концепції дизайну, Концепт Борд</li>
									<li>Побудова точної 3Д моделі в ArchiCad</li>
									<li>Розробка і моделювання індивідуальних мебелів в ArchiCad</li>
									<li>Фотореалістична візуалізація дизайну в Artlantic</li>
									<li>Постобробка рендерів у програмі AdobePhotoshop</li>
									<li>Скечинг кімнати в олівці і кольорі</li>
								</ul>

								<strong>Лекційний матеріал:</strong>
								<ul>
									<li>Вивчення історії  та стилів дизайн інтер'єру</li></li>
									<li>Креативне мислення</li>
									<li>Як створити гармонійний та стильний інтер'єр</li>
									<li>Аналіз трендових інтер'єрів</li>
									<li>Правила поєднання кольорів в інтер’єрі</li>
									<li>Вивчення історії та стилів дизайн інтер'єру</li>
									<li>Основи дизайн проектування</li>
									<li>Як правильно зняти обміри приміщення</li>
									<li>Архітектурні конструкції споруд</li>
									<li>Функціональна побудова простору, зонування середовища</li></li>
									<li>Основи Ергономіки і Антропометрії</li>
									<li>Теорія композиції в дизайні інтер'єру</li>
									<li>Кольорознавство. Значення кольору в дизайні інтер'єру</li>
									<li>Освітлення в інтер'єрі</li>
									<li>Матеріалознавство. Підбір декоративно-оздоблюваних матеріалів.</li>
									<li>Основи дизайн проектування</li>
									<li>Як правильно зняти обміри приміщення</li>
									<li>Архітектурні конструкції споруд</li>
									<li>Функціональна побудова простору, зонування середовища</li>
									<li>Основи Ергономіки і Антропометрії</li>
									<li>Теорія композиції в дизайні інтер'єру</li>
									<li>Кольорознавство. Значення кольору в дизайні інтер'єру</li>
									<li>Освітлення в інтер'єрі</li>
									<li>Матеріалознавство. Підбір декоративно-оздоблюваних матеріалів.</li>
									<li>Основи ремонтно-будівельних етапів</li>
									<li>Виїзні майстер класи: 2-3 спеціалізовані салони</li>
								</ul>

								<p><strong>Об`єм проектної роботи:</strong></p>
								<p>Дво-, трикімнатна квартира. Ви навчитесь виконувати весь об'єм роботи заявленої в програмі Базус. Також за для досягнення максимального ефекту навчитесь виконувати фотореалістичні візуалізації в спеціалізованій програмі Artlantic. Навчитесь проектувати не тількі житлові приміщення, але й розробляти дизайн санвузлів.</p> <p>Навчитесь виконувати всі необхідні робочі креслення для реалізації вашого дизайн-проекту.Отримаєте масу цікавої і корисної інформації на професійних майстер класах в елітних салонах Льова.Освоїте не тільки уніукальну технологію швидкої візуалізаціії Концепт Борд, а і техніку швидкого ескізування проекту вручну - скеч. Познайомитеся з основними ремонтно-будівельними етапами реалізації дизайн проекту. </p>
							</div>
						</div>
					</div>
				</div>
